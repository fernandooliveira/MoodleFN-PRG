 ...
 * @subpackage progress
 */
class progress_report_format_print{
    /**
     * consumed by get_string
     * @const string HEADING
     */  
    const HEADING          = 'printreportheading';
    
    /**
     * consumed by get_string
     * @const string SHORT_NAME
     */  
    const SHORT_NAME       = 'print';
    
    /**
     * consumed by get_string
     * @const string NAME_CODE_STRING
     */  
    const NAME_CODE_STRING = 'print';
    ...
    public function __construct($params) {
        ...
        $this->params = $params;
        $this->renderer = $PAGE->get_renderer('gradereport_progress', 'print');
    }
    ...
    public function render_content($formatted, $user) {
        ...
        echo $this->renderer->write_header($courseid, $heading);

        echo $formatted;

        echo $this->renderer->write_footer();
    }
